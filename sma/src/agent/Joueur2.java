...
import Containers.Joueur2Containner;
...
public class Joueur2 extends GuiAgent {
    private Joueur2Containner joueur2Containner;
    ...
    protected void setup() {
        joueur2Containner = (Joueur2Containner) getArguments()[0];
        joueur2Containner.setAgent(joueur2);
